...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__material_radios_html__ = __webpack_require__(19);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function(e,t){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(32),__webpack_require__(30),__webpack_require__(33)], __WEBPACK_AMD_DEFINE_FACTORY__ = (t),
...
module.exports = __webpack_require__(31).ObjectPath;
...
var html = "<div class=\"form-group schema-form-radios-cards {{::form.htmlClass}}\">\n  <label class=\"md-body-1\" ng-show=\"showTitle()\" aria-label=\"{{form.title}}\">{{::form.title}}</label>\n  <br />\n  <br />\n  <md-radio-group sf-field-model sf-changed=\"form\" ng-disabled=\"form.readonly\" name=\"{{form.key.join('.')}}\" sf-layout sf-messages>\n    <div ng-repeat=\"item in form.titleMap\" flex=\"33\" flex-gt-md=\"25\" layout-align=\"center center\" class=\"radio-buttons-card\"\n    md-colors=\"{\n      borderColor: item.active ? 'default-accent' : 'default-primary--0.5',\n    }\" ng-class=\"{'md-whiteframe-10dp': item.recommended}\">\n    <md-radio-button flex ng-value=\"item.value\" layout=\"column\">\n      <md-icon ng-show=\"::item.svgIcon\" md-svg-icon=\"{{::item.svgIcon}}\"></md-icon>\n    </md-radio-button>\n  </div>\n</md-radio-group>\n</div>\n";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
